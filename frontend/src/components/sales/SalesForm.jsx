...
const invoiceNumber = "FV-0001"; // por ahora fijo o generado

function SalesForm({ onSave, onCancel }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSave({ customer, date, paymentMethod, items, notes, total });
  };
