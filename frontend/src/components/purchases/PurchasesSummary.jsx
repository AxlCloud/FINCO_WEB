...
function PurchasesSummary({ purchase, onEdit, onCreditNote, onDebitNote, onClose }) {
  const { supplier, date, paymentMethod, items, notes, total } = purchase;
  ...
  const purchaseNumber = "PC-0001"; // por ahora fijo
        ...
        <div className="card-header">
          <div className="row">
            <div className="col-md-4">
              <strong>Purchase No.:</strong> {purchaseNumber}
            </div>
